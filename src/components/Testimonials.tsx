    ...
    <section className="py-24 bg-brand-purple text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeIn className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-heading font-bold uppercase leading-tight">
            Word on the Street
          </h3>
        </FadeIn>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <FadeIn key={index} delay={index * 0.15} direction="up">
              <div className="bg-brand-purple-light p-8 border-t-4 border-brand-orange h-full flex flex-col">
