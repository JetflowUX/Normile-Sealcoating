      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <FadeIn key={index} delay={index * 0.1} direction="up">
              <div className="bg-white p-8 border-t-4 border-brand-purple shadow-sm hover:shadow-md transition-shadow h-full">
                <div className="mb-6 bg-gray-50 w-16 h-16 flex items-center justify-center rounded-sm">
                  {service.icon}
                </div>
                <h4 className="font-heading text-2xl font-bold text-brand-asphalt uppercase mb-4">
                  {service.title}
                </h4>
