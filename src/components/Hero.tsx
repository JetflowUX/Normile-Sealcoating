...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 bg-brand-asphalt overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="max-w-3xl">
          <FadeIn>
            <div className="inline-flex items-center bg-brand-purple/80 border border-brand-purple-light px-4 py-2 mb-6">
          ...
          <FadeIn delay={0.1}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-white uppercase leading-[0.9] mb-6 text-balance">
              They Pave It,
              <br />
          ...
          <FadeIn
            delay={0.4}
            className="grid grid-cols-1 sm:grid-cols-3 gap-6 border-t border-gray-700 pt-8"
          >
